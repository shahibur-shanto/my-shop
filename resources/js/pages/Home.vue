...
<!--<template>-->
<!--    &lt;!&ndash; Page wrapper with blur effect &ndash;&gt;-->
...
<!--                &lt;!&ndash; Auth Buttons Desktop &ndash;&gt;-->
...
<!--                            Log out-->
<!--                        </button>-->
<!--&lt;!&ndash;                        <Link :href="route('logout')" method="post" as="button" class="px-4 py-2 bg-red-600 text-white rounded hover:bg-red-700">Log out</Link>&ndash;&gt;-->
<!--                    </template>-->
<!--                    <template v-else>-->
...
<!--                            </div>-->
<!--                            <p class="text-gray-700">{{ new_arrival.price }}</p>-->
<!--        &lt;!&ndash;                    <Link href="#" class="mt-2 px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700 w-full text-center">Add to Cart</Link>&ndash;&gt;-->
<!--                            <button @click="handleAddToCart(new_arrival)" class="mt-2 px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700 w-full text-center cursor-pointer">Add to Cart</button>-->
<!--                        </div>-->
<!--                    </div>-->
<!--                </section>-->
